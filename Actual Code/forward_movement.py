...
def forward():
    ...
    input16 = Pin(16, Pin.IN, Pin.PULL_DOWN) # Think carefully whether you need pull up or pull down
    input17 = Pin(17, Pin.IN, Pin.PULL_DOWN) # Think carefully whether you need pull up or pull down
    ...
    while True:
        ...
        if input16.value() == 0 and input17.value() == 0:
            ...
            motor3.Reverse(70)  # Motor 3 moves backward at 70% speed
            motor4.Forward(60)  # Motor 4 moves forward at 60% speed

        elif input16.value() == 0 and input17.value() == 1:
            motor3.Reverse(60)  # Motor 3 moves backward at 60% speed
            motor4.Forward(70)  # Motor 4 moves forward at 70% speed
        else:
            motor3.Reverse(60)  # Motor 3 moves backward at 60% speed
            motor4.Forward(60)  # Motor 4 moves forward at 50% speed
